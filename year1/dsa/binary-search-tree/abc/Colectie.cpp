...
// complexitate: O(n) - inaltimea curenta a arborelui
// caz favorabil: theta(1) - elementul este radacina
// caz defavorabil: theta(n) - elementele sunt adaugate in ordine cresc/desc => arbore liniar
// caz mediu: O(log2n) - daca arborele este aproape de un arbore echilibrat
int Colectie::eliminaToateAparitiile(TElem elem) {
	return elimina_rec(rad, -1, elem);
}
